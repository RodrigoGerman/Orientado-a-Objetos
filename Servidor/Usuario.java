...
public class Usuario implements Serializable{
	...
	/** * Metodo constructor para inicializar solo su nombre de usuario y password, se utiliza para saber si existe el usuario.*/
	...
	public void setUserName(String user){
		...
		if(!data.getexistsUsuario(user)){
			this.user = user;
		}
	}

	/** * Metodo para asignar la contraseña del usuario.*/
